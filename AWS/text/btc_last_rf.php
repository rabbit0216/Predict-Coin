...
<html>
   <body>
    ...
    $sql = "SELECT * FROM BTC ORDER BY date DESC LIMIT 1";
    ...
    //$psql = "SELECT * FROM BTC_C where date >= date_add(now(), interval 0 hour) ORDER BY date LIMIT 1";
    $psql = "SELECT * FROM BTC_C ORDER BY date DESC LIMIT 1";
