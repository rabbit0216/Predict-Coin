...
<html lang="ko">
  ...
  <div class="wrap">
    ...
    $result = mysqli_query($conn,"SELECT close, date AS datetime FROM SAND ORDER BY datetime DESC limit 168");
    ...
    $presult = mysqli_query($pconn,"SELECT close, date AS datetime FROM SAND_C ORDER BY datetime");
